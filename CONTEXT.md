...
- **Pressure Setpiece** — a hand-authored sequence of shots used to tune and replay a specific Sequence Pressure Pattern before it is generalized by the Shot Plan generator.
